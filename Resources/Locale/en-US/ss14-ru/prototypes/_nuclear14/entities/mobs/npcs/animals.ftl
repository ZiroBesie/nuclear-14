...
ent-N14MobDeathclawMaid = deathclaw maid
    .desc = They put maid outfit on that thing?!
...
ent-N14MobCaravanBrahmin = caravan pack brahmin
    .desc = A brahmin lugging a crate for the caravan.
ent-N14MobBighorner = bighorner
    .desc = Fluffy but with horns.
ent-N14MobRadstag = radstag
    .desc = Stag? Raaaad
ent-N14MobChicken = chicken
    .desc = Cluck cluck.
